...
$idMenu = $_GET["idMenu"];
try {
    $request = $db->query("SELECT * FROM menus WHERE Id_Menu = $idMenu");
...
try {
    $request1 = $db->query("SELECT * FROM entree ");
    ...
    <section class="section-reservation bg1-pattern p-t-100 p-b-113">
        <div class="container">
            ...
            <div class="col-lg-12 p-b-30">
                ...
                <form class="wrap-form-reservation size22 m-l-r-auto" method="POST" action="modification_menu.php">
                <?php foreach ($lesMenus as $leMenu) { ?>
                    <div class="row">
                        ...
                        <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="Nom" required="required" placeholder="Nom" value="<?php echo $leMenu->getNom(); ?>" >
                        </div>
                        <!-- Description -->
                        <span class="txt9">
                            Description
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="wrap-inputtime size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                ...
                                <select class="selection-1" name="entree">
                                    <?php foreach ($lesEntrees as $lEntree) { ?> <option value="<?php echo $lEntree->getId_Entree(); ?>"> <?php echo $lEntree->getNom(); ?></option> <?php } ?>
                                </select>
                    ...
                    <div class="wrap-btn-booking flex-c-m m-t-6">
                        <!-- Button3 -->
                        <input type="submit" class="btn3 flex-c-m size13 txt11 trans-0-4" value="Modifier" >
                        <input type="hidden"  name="modifMenu" value="<?php echo $leMenu->getId_Menu();  ?>">
                        <?php }?>
                </form>
            </div>
        </div>
